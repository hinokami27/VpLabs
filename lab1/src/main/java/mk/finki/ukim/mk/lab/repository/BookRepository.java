...
public class BookRepository {
    ...
    public BookRepository(BookStoreRepository bookStoreRepository){
        ...
        books.add(new Book("1111111111111","book1","genre1",2011,bookStores.get(0)));
        books.add(new Book("2222222222222","book2","genre2",2012,bookStores.get(1)));
        books.add(new Book("3333333333333","book3","genre3",2013,bookStores.get(2)));
        books.add(new Book("4444444444444","book4","genre4",2014,bookStores.get(3)));
        books.add(new Book("5555555555555","book5","genre5",2015,bookStores.get(4)));
    }
    ...
    public void addBookToBooks(String title, String isbn, String genre, int year, Long id) {
        ...
        Book newBook = new Book(isbn,title,genre,year,bookStoreRepository.findByID(id));
        books.add(newBook);
    }
